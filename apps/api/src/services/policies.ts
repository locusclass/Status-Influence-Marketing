...
export function buildCurrentPolicyDocuments(): {
  ...
  return {
    privacy_policy: {
      ...
      summary:
        'This policy explains how Prime Status collects, uses, shares, protects, and retains personal data for account access, WhatsApp Status promotions, verification, payments, and fraud prevention.',
      sections: [
        {
    ...
    platform_policy: {
      ...
      summary:
        'This policy sets the rules for lawful use of Prime Status, including product pages, WhatsApp Status promotions, uploads, verification, and payment activity.',
      sections: [
        {
