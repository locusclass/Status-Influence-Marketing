...
function rejectInvalidHandlerJazAccess(access, reply) {
    ...
    return {
        ...
        detail: "Handler's Jaz requires a signed-in admin account backed by a stored admin profile.",
    };
}
